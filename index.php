...
JWT_SECRET=vg4NJJVkcXSATgfjhTbE3PGM8b0WRjBuqrP2HCJAIgLSQn5wNe6SWIP0AyhGi7Ev
JWT_TTL = 90000
...
";
										$status = 'ok';
										$envpath = dirname(__DIR__, 1) . '/core/vendor/bin/php/.env';
   ...
   $stmt->execute();						
									...
									<div class="info-item">
										...
										<div class="row">
											<div class="information-form-group col-sm-6">
												<input type="text" name="user" placeholder="Username" value="MehediBS" required>
											</div>
											<div class="information-form-group col-sm-6">
												<input type="text" name="code" placeholder="Purchase Code" value="MehediBS" required>
											</div>
										</div>
									</div>
									<div class="info-item">
	...
	<footer class="section-bg py-3 text-center">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://viserlab.com/">ViserLab</a> | <?php echo str_rot13('<n uers="uggcf://GrpuJbeyqOQ.vasb">Ahyyrq Ol Zrurqv Unfna</n>');?> </p>
		</div>
	</footer>
	<style>
		#hide{
